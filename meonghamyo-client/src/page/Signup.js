    ...
    <div className="signupForm">
      ...
      <div className="inputArea">
        <div className="inputAndName">
          ...
          />
          {emailSwitch ? null : (
            <div className="errorEmail">이메일을 올바르게 입력해주세요.</div>
          )}
        </div>
        ...
        <div className="inputAndName">
          ...
          <div className="inputAreaBirth">
            <div className="birthInputs">
              ...
              ></input>
              {newUser.birth && newUser.day ? <FcCheckmark size="35" /> : null}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="inputArea">
        ...
        {nicknameSwitch && newUser.nickname ? <FcCheckmark size="35" /> : null}
      </div>
